...
def suru_iha_custom_lineup(target_latitude, target_longitude, target_altitude, drones):
    try:
        ...
        drone_positions = {
             '/drone1': (target_latitude , target_longitude -0.0001, target_altitude),  # Drone 3 at right of target
            '/drone2': (target_latitude - 0.0009 , target_longitude + 0.001, target_altitude),  # Drone 2 slightly to the left
            '/drone3': (target_latitude + 0.0009 , target_longitude + 0.001, target_altitude)   # Drone 1 at the leftmost position
